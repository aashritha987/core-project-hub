...
import {
  ...
  Zap, BarChart3, Bug, Milestone, Users, X
} from 'lucide-react';
      ...
      <div className="p-3">
        <div className="relative">
          ...
          {searchQuery.trim().length > 0 ? (
            ...
            <kbd className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded border border-border pointer-events-none">
              ⌘K
            </kbd>
          )}
        </div>
